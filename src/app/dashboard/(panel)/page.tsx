...
import { Card, CardHeader, CardTitle, CardContent, StatCard, Button } from '@/admin/components/ui';
                            ...
                            <div className="flex h-full w-full items-end justify-around gap-md">
                                {revenueData.map((item) => (
                                    <div key={item.month} className="flex h-full flex-1 flex-col items-center">
                                        <div
                                            className="group relative w-full max-w-[60px] cursor-pointer rounded-t-md bg-accent-gradient transition-all duration-[250ms] hover:brightness-110 hover:scale-y-[1.02]"
