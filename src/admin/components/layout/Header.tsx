...
export function Header({ sidebarCollapsed, onMenuClick }: HeaderProps) {
    ...
    return (
        <header
            className="fixed left-0 right-0 top-0 z-50 flex h-[var(--header-height)] items-center justify-between border-b border-border bg-bg-secondary px-lg transition-[margin-left] duration-[250ms] max-md:!ml-0"
            style={{
                ...
                <div className="relative">
                    ...
                    {showProfile && (
                        <div className="absolute right-0 top-full z-[100] mt-2 min-w-[260px] overflow-hidden rounded-xl border border-border bg-bg-secondary shadow-xl animate-slide-in-down">
                            ...
                            <a href="/dashboard/settings" className="flex items-center gap-sm px-md py-sm text-sm text-text-secondary transition-all duration-150 hover:bg-bg-tertiary hover:text-text-primary">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                            ...
                            <button
                                ...
                                className="flex w-full items-center gap-sm px-md py-sm text-left text-sm text-danger transition-all duration-150 hover:bg-danger-bg"
                            >
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
