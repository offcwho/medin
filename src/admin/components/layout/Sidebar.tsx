...
export function Sidebar({ collapsed = false, onToggle }: SidebarProps) {
    ...
    return (
        <aside
            className={[
                'fixed bottom-0 left-0 top-0 z-[100] flex w-[var(--sidebar-width)] flex-col border-r border-border bg-bg-secondary transition-[width] duration-[250ms] max-md:-translate-x-full max-md:transition-transform',
